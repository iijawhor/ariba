...
const TeacherList = ({ userModal, setUserModal, mode, setMode }) => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-5 gap-2">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center cursor-pointer gap-1 border border-[#2C80FF] px-2 py-1 rounded-full bg-[#2C80FF] text-white hover:bg-blue-600 transition"
            >
              <svg
      ...
      {/* ✅ Modal rendered using Portal - appears at page center */}
      {mode === "add" &&
        userModal &&
        createPortal(
          <UserModal
            ...
            userData={null}
          />,
          document.body // Renders modal at body level
        )}
    </>
  );
};
