...
const StudentDetails = ({
  ...
  mode,
  setMode,
  setShowSidebar // add sidebar toggle like TeacherDetails
}) => {
  ...
  return (
    <div className="relative h-full flex flex-col gap-6 p-3 md:p-6 bg-gray-50">
      {/* ===== Header ===== */}
      <div className="bg-white rounded-xl shadow-md p-3 md:p-4 flex items-center justify-between sticky top-0 z-0">
      ...
      <div className="bg-gray-100 rounded-xl shadow-inner p-5 flex flex-col gap-2">
        <h2 className="text-base md:text-lg font-semibold text-gray-700">
          About {userData?.userRole || "Student"}
        </h2>
